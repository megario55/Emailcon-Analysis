  ...
  try {
    ...
    const emailContent = previewContent.map((item) => {
      if (item.type === 'para') {
        ...
        return `<p class="head" style="font-size:${item.style.fontSize};border-radius:10px;padding:10px;font-weight:bold;color:${item.style.color};margin-top:10px;text-align:${item.style.textAlign};background-color:${item.style.backgroundColor}">${item.content}</p>`;
...
<tr>
  ...
  `;
        ...
        case 'head':
          return `<p class="head" style="${styleString};border-radius:10px;padding:10px;font-weight:bold;margin-top:10px;">${content}</p>`;
        case 'para':
          return `<div class="para" style="${styleString};border-radius:10px;padding:10px;margin-top:20px;">${content}</div>`;
        case 'button':
